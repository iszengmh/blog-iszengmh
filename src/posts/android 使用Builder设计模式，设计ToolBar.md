---
title: android之使用Builder设计模式，设计ToolBar
published: 2017-08-30 16:16:51
description: 'android之使用Builder设计模式，设计ToolBar'
image: ''
tags: [android]
category: android
draft: false 
...
<h1 id="63LYi">使用Builder设计模式，设计ToolBar</h1>
<h2 id="yMkKq">Builder设计模式解析</h2>
android也有不地方采用了Builder设计模式的，比如NotificationCompat.Builder和AlertDialog.Builder就采用了Builder的设计模式



<h3 id="K8ERx">最典型的代码示例</h3>
<h4 id="2y5eB">NotificationCompat.Builder</h4>
...
<h4 id="gcrwP">AlertDialog.Builder</h4>
...
<h3 id="ualRh">接口抽象toolbar的规范public interface INavigation</h3>
...
<h3 id="O7mI6">抽象并实现INavigation——public abstract class AbsNavigation</h3>
...
<h3 id="1ZQNy">搭建toolbar布局框架——abstract class DefaultNavigation（多个子类（功能）继承此父类，功能需求就可以多变）</h3>
...
<h3 id="bFVDJ">主页toolbar的实现——HomeNavigation</h3>
...
<h3 id="1isN0">HomeNavigation的调用,即实例化</h3>
...
<h3 id="8bENk">主页toolbar实现效果</h3>
![](https://cdn.nlark.com/yuque/0/2020/jpeg/244275/1586007795096-e9eaa66f-cd3b-4327-85e3-d4ffd3d9a1c9.jpeg)



<h2 id="XUau8">布局代码就不给了</h2>
